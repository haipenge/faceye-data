...
public class DB2HDFSRunner extends Configured implements Tool {
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new DB2HDFSRunner(), args);
	}

	public DB2HDFSRunner() {
	...
	private int process(String[] args) throws Exception {
		...
		job.setJarByClass(DB2HDFSRunner.class);
